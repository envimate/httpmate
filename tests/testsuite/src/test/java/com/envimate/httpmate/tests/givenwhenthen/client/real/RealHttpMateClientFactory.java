...
public final class RealHttpMateClientFactory implements ClientFactory {

    public static ClientFactory theRealHttpMateClient() {
        return new RealHttpMateClientFactory();
    }

    @Override
    public HttpClientWrapper createClient(final Deployment deployment) {
        return realHttpMateClientWrapper(deployment);
    }

    @Override
    public String toString() {
        return "httpmateclient";
    }
}
